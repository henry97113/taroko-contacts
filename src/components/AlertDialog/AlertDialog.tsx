...
const AlertDialogHeader = ({
  ...
  <div className={clsx(styles.AlertDialogHeader, className)} {...props} />
);
...
const AlertDialogFooter = ({
  ...
  <div className={clsx(styles.AlertDialogFooter, className)} {...props} />
);
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Cancel asChild>
    <Button
      ref={ref}
      variant="outline"
      className={clsx(styles.AlertDialogCancel, className)}
      {...props}
    />
